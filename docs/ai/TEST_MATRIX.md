...
| Multiplexed fairness telemetry            | ✅   | ✅          | —   | Atomic/RAII tests cover admission waits, pipeline depth, active streams, byte/frame counters, resets, and burst yields; real TCP verifies exact Agent/Edge directional bytes for four concurrent 256 KiB streams without identity or payload labels. |
